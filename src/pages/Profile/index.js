...
export default function Profile() {
    ...
    // pegar dados que estao no saga e já colocar no formulário de edição
    ...
    // Toda vez que o profile altera a func vai resetar valores de senha
    useEffect(() => {
        setOldPassword('');
        setPassword('');
        setConfirmPassword('');
